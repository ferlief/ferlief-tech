...
const DICIONARIO = {
  pt: {
    ...
    'trab.lead': 'Duas peças completas para avaliar antes de contratar: estrutura, ritmo de leitura, acabamento e comportamento no celular.',
    ...
    'trab8.titulo': 'Marina & Thiago',
    'trab8.tipo': 'Edição de vídeo · filme de casamento',
    'trab8.texto': 'Corte cinematográfico de 10 minutos a partir de captação bruta em 4K: decupagem, estrutura de arco emocional, discursos e áudio ambiente preservados, grade de cor do início ao fim.',
    'trab8.link': 'Abrir o portfólio',
    'trab8.fichaObjetivoTexto': 'Transformar um dia inteiro de captação documental — sem encenação, sem retomada — em 10 minutos que sustentam a curva emocional da cerimônia à festa.',
    'trab8.fichaDecisoesTexto': 'Áudio ambiente e discursos como camada principal, trilha só para sustentar. Estrutura por arco emocional, não por ordem cronológica estrita.',
    'trab8.fichaEntregaTexto': 'Corte final de 10 minutos em 4K, versão cortada para redes, e o material bruto correspondente ao lado do resultado — para julgar a distância entre captação e edição.',
  ...
  en: {
    ...
    'trab.lead': 'Two complete pieces to judge before hiring: structure, reading rhythm, finish, and behavior on a phone.',
    'trab1.titulo': 'Clínica Vitalis',
    ...
    'trab8.titulo': 'Marina & Thiago',
    'trab8.tipo': 'Video editing · wedding film',
    'trab8.texto': 'A 10-minute cinematic cut built from raw 4K footage: shot logging, emotional-arc structuring, speeches and ambient sound kept intact, color grade carried through from start to finish.',
    'trab8.link': 'Open the portfolio',
    'trab8.fichaObjetivoTexto': 'Turn a full day of documentary-style footage — no staging, no retakes — into 10 minutes that hold the emotional arc from ceremony to reception.',
    'trab8.fichaDecisoesTexto': 'Ambient sound and speeches as the main layer, score only in support. Structured by emotional arc rather than strict chronological order.',
    'trab8.fichaEntregaTexto': 'Final 10-minute cut in 4K, a trimmed version for social, and the matching raw footage alongside the result — to judge the distance between capture and edit.',
